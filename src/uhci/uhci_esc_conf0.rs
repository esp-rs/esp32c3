#[doc = "Reader of register UHCI_ESC_CONF0"]
pub type R = crate::R<u32, super::UHCI_ESC_CONF0>;
#[doc = "Writer for register UHCI_ESC_CONF0"]
pub type W = crate::W<u32, super::UHCI_ESC_CONF0>;
#[doc = "Register UHCI_ESC_CONF0 `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_ESC_CONF0 {
    type Type = u32;
    #[inline(always)]
