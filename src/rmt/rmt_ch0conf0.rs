#[doc = "Reader of register RMT_CH0CONF0"]
pub type R = crate::R<u32, super::RMT_CH0CONF0>;
#[doc = "Writer for register RMT_CH0CONF0"]
pub type W = crate::W<u32, super::RMT_CH0CONF0>;
#[doc = "Register RMT_CH0CONF0 `reset()`'s with value 0"]
impl crate::ResetValue for super::RMT_CH0CONF0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `RMT_CONF_UPDATE_CH0`"]
pub struct RMT_CONF_UPDATE_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> RMT_CONF_UPDATE_CH0_W<'a> {
...
#[doc = "Write proxy for field `RMT_AFIFO_RST_CH0`"]
pub struct RMT_AFIFO_RST_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> RMT_AFIFO_RST_CH0_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `RMT_CARRIER_EFF_EN_CH0`"]
pub type RMT_CARRIER_EFF_EN_CH0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RMT_CARRIER_EFF_EN_CH0`"]
pub struct RMT_CARRIER_EFF_EN_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> RMT_CARRIER_EFF_EN_CH0_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `RMT_TX_STOP_CH0`"]
pub type RMT_TX_STOP_CH0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RMT_TX_STOP_CH0`"]
pub struct RMT_TX_STOP_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> RMT_TX_STOP_CH0_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `RMT_MEM_TX_WRAP_EN_CH0`"]
pub type RMT_MEM_TX_WRAP_EN_CH0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RMT_MEM_TX_WRAP_EN_CH0`"]
pub struct RMT_MEM_TX_WRAP_EN_CH0_W<'a> {
    w: &'a mut W,
}
impl<'a> RMT_MEM_TX_WRAP_EN_CH0_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn rmt_carrier_out_lv_ch0(&self) -> RMT_CARRIER_OUT_LV_CH0_R {
        RMT_CARRIER_OUT_LV_CH0_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    pub fn rmt_carrier_en_ch0(&self) -> RMT_CARRIER_EN_CH0_R {
        RMT_CARRIER_EN_CH0_R::new(((self.bits >> 21) & 0x01) != 0)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn rmt_carrier_eff_en_ch0(&self) -> RMT_CARRIER_EFF_EN_CH0_R {
        RMT_CARRIER_EFF_EN_CH0_R::new(((self.bits >> 20) & 0x01) != 0)
    }
    #[doc = "Bits 16:18"]
    #[inline(always)]
    pub fn rmt_mem_size_ch0(&self) -> RMT_MEM_SIZE_CH0_R {
        RMT_MEM_SIZE_CH0_R::new(((self.bits >> 16) & 0x07) as u8)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    pub fn rmt_div_cnt_ch0(&self) -> RMT_DIV_CNT_CH0_R {
        RMT_DIV_CNT_CH0_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn rmt_tx_stop_ch0(&self) -> RMT_TX_STOP_CH0_R {
        RMT_TX_STOP_CH0_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn rmt_idle_out_en_ch0(&self) -> RMT_IDLE_OUT_EN_CH0_R {
        RMT_IDLE_OUT_EN_CH0_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn rmt_idle_out_lv_ch0(&self) -> RMT_IDLE_OUT_LV_CH0_R {
        RMT_IDLE_OUT_LV_CH0_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn rmt_mem_tx_wrap_en_ch0(&self) -> RMT_MEM_TX_WRAP_EN_CH0_R {
        RMT_MEM_TX_WRAP_EN_CH0_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn rmt_tx_conti_mode_ch0(&self) -> RMT_TX_CONTI_MODE_CH0_R {
        RMT_TX_CONTI_MODE_CH0_R::new(((self.bits >> 3) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 24"]
    #[inline(always)]
    pub fn rmt_conf_update_ch0(&mut self) -> RMT_CONF_UPDATE_CH0_W {
        RMT_CONF_UPDATE_CH0_W { w: self }
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn rmt_afifo_rst_ch0(&mut self) -> RMT_AFIFO_RST_CH0_W {
        RMT_AFIFO_RST_CH0_W { w: self }
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    ...
    #[doc = "Bit 20"]
    #[inline(always)]
    pub fn rmt_carrier_eff_en_ch0(&mut self) -> RMT_CARRIER_EFF_EN_CH0_W {
        RMT_CARRIER_EFF_EN_CH0_W { w: self }
    }
    #[doc = "Bits 16:18"]
    #[inline(always)]
    ...
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn rmt_tx_stop_ch0(&mut self) -> RMT_TX_STOP_CH0_W {
        RMT_TX_STOP_CH0_W { w: self }
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    ...
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn rmt_mem_tx_wrap_en_ch0(&mut self) -> RMT_MEM_TX_WRAP_EN_CH0_W {
        RMT_MEM_TX_WRAP_EN_CH0_W { w: self }
    }
    #[doc = "Bit 3"]
    #[inline(always)]
