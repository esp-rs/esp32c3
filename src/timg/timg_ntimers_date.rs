#[doc = "Reader of register TIMG_NTIMERS_DATE"]
pub type R = crate::R<u32, super::TIMG_NTIMERS_DATE>;
#[doc = "Writer for register TIMG_NTIMERS_DATE"]
pub type W = crate::W<u32, super::TIMG_NTIMERS_DATE>;
#[doc = "Register TIMG_NTIMERS_DATE `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMG_NTIMERS_DATE {
    type Type = u32;
    #[inline(always)]
