#[doc = "Reader of register TIMG_WDTCONFIG2"]
pub type R = crate::R<u32, super::TIMG_WDTCONFIG2>;
#[doc = "Writer for register TIMG_WDTCONFIG2"]
pub type W = crate::W<u32, super::TIMG_WDTCONFIG2>;
#[doc = "Register TIMG_WDTCONFIG2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMG_WDTCONFIG2 {
    type Type = u32;
    #[inline(always)]
