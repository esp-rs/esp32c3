#[doc = "Reader of register SPI_DATE"]
pub type R = crate::R<u32, super::SPI_DATE>;
#[doc = "Writer for register SPI_DATE"]
pub type W = crate::W<u32, super::SPI_DATE>;
#[doc = "Register SPI_DATE `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_DATE {
    type Type = u32;
    #[inline(always)]
