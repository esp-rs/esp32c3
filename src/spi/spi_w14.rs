#[doc = "Reader of register SPI_W14"]
pub type R = crate::R<u32, super::SPI_W14>;
#[doc = "Writer for register SPI_W14"]
pub type W = crate::W<u32, super::SPI_W14>;
#[doc = "Register SPI_W14 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_W14 {
    type Type = u32;
    #[inline(always)]
