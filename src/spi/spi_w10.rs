#[doc = "Reader of register SPI_W10"]
pub type R = crate::R<u32, super::SPI_W10>;
#[doc = "Writer for register SPI_W10"]
pub type W = crate::W<u32, super::SPI_W10>;
#[doc = "Register SPI_W10 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_W10 {
    type Type = u32;
    #[inline(always)]
