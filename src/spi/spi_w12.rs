#[doc = "Reader of register SPI_W12"]
pub type R = crate::R<u32, super::SPI_W12>;
#[doc = "Writer for register SPI_W12"]
pub type W = crate::W<u32, super::SPI_W12>;
#[doc = "Register SPI_W12 `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_W12 {
    type Type = u32;
    #[inline(always)]
