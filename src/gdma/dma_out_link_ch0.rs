#[doc = "Reader of register DMA_OUT_LINK_CH0"]
pub type R = crate::R<u32, super::DMA_OUT_LINK_CH0>;
#[doc = "Writer for register DMA_OUT_LINK_CH0"]
pub type W = crate::W<u32, super::DMA_OUT_LINK_CH0>;
#[doc = "Register DMA_OUT_LINK_CH0 `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_OUT_LINK_CH0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `DMA_OUTLINK_PARK_CH0`"]
pub type DMA_OUTLINK_PARK_CH0_R = crate::R<bool, bool>;
#[doc = "Reader of field `DMA_OUTLINK_RESTART_CH0`"]
pub type DMA_OUTLINK_RESTART_CH0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DMA_OUTLINK_RESTART_CH0`"]
...
#[doc = "Reader of field `DMA_OUTLINK_START_CH0`"]
pub type DMA_OUTLINK_START_CH0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DMA_OUTLINK_START_CH0`"]
...
#[doc = "Reader of field `DMA_OUTLINK_STOP_CH0`"]
pub type DMA_OUTLINK_STOP_CH0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DMA_OUTLINK_STOP_CH0`"]
...
#[doc = "Reader of field `DMA_OUTLINK_ADDR_CH0`"]
pub type DMA_OUTLINK_ADDR_CH0_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `DMA_OUTLINK_ADDR_CH0`"]
