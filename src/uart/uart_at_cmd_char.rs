#[doc = "Reader of register UART_AT_CMD_CHAR"]
pub type R = crate::R<u32, super::UART_AT_CMD_CHAR>;
#[doc = "Writer for register UART_AT_CMD_CHAR"]
pub type W = crate::W<u32, super::UART_AT_CMD_CHAR>;
#[doc = "Register UART_AT_CMD_CHAR `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_AT_CMD_CHAR {
    type Type = u32;
    #[inline(always)]
