#[doc = "Reader of register UART_SLEEP_CONF"]
pub type R = crate::R<u32, super::UART_SLEEP_CONF>;
#[doc = "Writer for register UART_SLEEP_CONF"]
pub type W = crate::W<u32, super::UART_SLEEP_CONF>;
#[doc = "Register UART_SLEEP_CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_SLEEP_CONF {
    type Type = u32;
    #[inline(always)]
