#[doc = "Reader of register UART_SWFC_CONF0"]
pub type R = crate::R<u32, super::UART_SWFC_CONF0>;
#[doc = "Writer for register UART_SWFC_CONF0"]
pub type W = crate::W<u32, super::UART_SWFC_CONF0>;
#[doc = "Register UART_SWFC_CONF0 `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_SWFC_CONF0 {
    type Type = u32;
    #[inline(always)]
...
pub type UART_XOFF_THRESHOLD_R = crate::R<u16, u16>;
...
impl R {
    ...
    pub fn uart_xoff_char(&self) -> UART_XOFF_CHAR_R {
        UART_XOFF_CHAR_R::new(((self.bits >> 9) & 0xff) as u8)
    }
    #[doc = "Bits 0:8"]
    #[inline(always)]
    pub fn uart_xoff_threshold(&self) -> UART_XOFF_THRESHOLD_R {
        UART_XOFF_THRESHOLD_R::new((self.bits & 0x01ff) as u16)
    }
}
impl W {
    #[doc = "Bits 9:16"]
