#[doc = "Reader of register UART_DATE"]
pub type R = crate::R<u32, super::UART_DATE>;
#[doc = "Writer for register UART_DATE"]
pub type W = crate::W<u32, super::UART_DATE>;
#[doc = "Register UART_DATE `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_DATE {
    type Type = u32;
    #[inline(always)]
