#[doc = "Reader of register GPIO_SIGMADELTA1"]
pub type R = crate::R<u32, super::GPIO_SIGMADELTA1>;
#[doc = "Writer for register GPIO_SIGMADELTA1"]
pub type W = crate::W<u32, super::GPIO_SIGMADELTA1>;
#[doc = "Register GPIO_SIGMADELTA1 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_SIGMADELTA1 {
    type Type = u32;
    #[inline(always)]
