#[doc = "Reader of register GPIO_SIGMADELTA_CG"]
pub type R = crate::R<u32, super::GPIO_SIGMADELTA_CG>;
#[doc = "Writer for register GPIO_SIGMADELTA_CG"]
pub type W = crate::W<u32, super::GPIO_SIGMADELTA_CG>;
#[doc = "Register GPIO_SIGMADELTA_CG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_SIGMADELTA_CG {
    type Type = u32;
    #[inline(always)]
