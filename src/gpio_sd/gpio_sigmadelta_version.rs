#[doc = "Reader of register GPIO_SIGMADELTA_VERSION"]
pub type R = crate::R<u32, super::GPIO_SIGMADELTA_VERSION>;
#[doc = "Writer for register GPIO_SIGMADELTA_VERSION"]
pub type W = crate::W<u32, super::GPIO_SIGMADELTA_VERSION>;
#[doc = "Register GPIO_SIGMADELTA_VERSION `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_SIGMADELTA_VERSION {
    type Type = u32;
    #[inline(always)]
