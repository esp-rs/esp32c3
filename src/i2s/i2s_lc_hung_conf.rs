#[doc = "Reader of register I2S_LC_HUNG_CONF"]
pub type R = crate::R<u32, super::I2S_LC_HUNG_CONF>;
#[doc = "Writer for register I2S_LC_HUNG_CONF"]
pub type W = crate::W<u32, super::I2S_LC_HUNG_CONF>;
#[doc = "Register I2S_LC_HUNG_CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::I2S_LC_HUNG_CONF {
    type Type = u32;
    #[inline(always)]
