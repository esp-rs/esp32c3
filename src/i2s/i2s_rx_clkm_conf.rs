#[doc = "Reader of register I2S_RX_CLKM_CONF"]
pub type R = crate::R<u32, super::I2S_RX_CLKM_CONF>;
#[doc = "Writer for register I2S_RX_CLKM_CONF"]
pub type W = crate::W<u32, super::I2S_RX_CLKM_CONF>;
#[doc = "Register I2S_RX_CLKM_CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::I2S_RX_CLKM_CONF {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `I2S_MCLK_SEL`"]
pub type I2S_MCLK_SEL_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `I2S_MCLK_SEL`"]
...
#[doc = "Reader of field `I2S_RX_CLK_SEL`"]
pub type I2S_RX_CLK_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `I2S_RX_CLK_SEL`"]
...
#[doc = "Reader of field `I2S_RX_CLK_ACTIVE`"]
pub type I2S_RX_CLK_ACTIVE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `I2S_RX_CLK_ACTIVE`"]
...
#[doc = "Reader of field `I2S_RX_CLKM_DIV_NUM`"]
pub type I2S_RX_CLKM_DIV_NUM_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `I2S_RX_CLKM_DIV_NUM`"]
