#[doc = "Reader of register I2C_SLAVE_ADDR"]
pub type R = crate::R<u32, super::I2C_SLAVE_ADDR>;
#[doc = "Writer for register I2C_SLAVE_ADDR"]
pub type W = crate::W<u32, super::I2C_SLAVE_ADDR>;
#[doc = "Register I2C_SLAVE_ADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::I2C_SLAVE_ADDR {
    type Type = u32;
    #[inline(always)]
