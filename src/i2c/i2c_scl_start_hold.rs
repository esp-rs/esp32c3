#[doc = "Reader of register I2C_SCL_START_HOLD"]
pub type R = crate::R<u32, super::I2C_SCL_START_HOLD>;
#[doc = "Writer for register I2C_SCL_START_HOLD"]
pub type W = crate::W<u32, super::I2C_SCL_START_HOLD>;
#[doc = "Register I2C_SCL_START_HOLD `reset()`'s with value 0"]
impl crate::ResetValue for super::I2C_SCL_START_HOLD {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn i2c_scl_start_hold_time(&self) -> I2C_SCL_START_HOLD_TIME_R {
        I2C_SCL_START_HOLD_TIME_R::new((self.bits & 0x01ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:8"]
