#[doc = "Reader of register GPIO_FUNC25_OUT_SEL_CFG"]
pub type R = crate::R<u32, super::GPIO_FUNC25_OUT_SEL_CFG>;
#[doc = "Writer for register GPIO_FUNC25_OUT_SEL_CFG"]
pub type W = crate::W<u32, super::GPIO_FUNC25_OUT_SEL_CFG>;
#[doc = "Register GPIO_FUNC25_OUT_SEL_CFG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_FUNC25_OUT_SEL_CFG {
    type Type = u32;
    #[inline(always)]
...
pub type GPIO_FUNC25_OUT_SEL_R = crate::R<u8, u8>;
...
impl R {
    ...
    pub fn gpio_func25_oen_inv_sel(&self) -> GPIO_FUNC25_OEN_INV_SEL_R {
        GPIO_FUNC25_OEN_INV_SEL_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn gpio_func25_oen_sel(&self) -> GPIO_FUNC25_OEN_SEL_R {
        GPIO_FUNC25_OEN_SEL_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn gpio_func25_out_inv_sel(&self) -> GPIO_FUNC25_OUT_INV_SEL_R {
        GPIO_FUNC25_OUT_INV_SEL_R::new(((self.bits >> 8) & 0x01) != 0)
    }
    #[doc = "Bits 0:7"]
    #[inline(always)]
    pub fn gpio_func25_out_sel(&self) -> GPIO_FUNC25_OUT_SEL_R {
        GPIO_FUNC25_OUT_SEL_R::new((self.bits & 0xff) as u8)
    }
}
impl W {
    #[doc = "Bit 10"]
