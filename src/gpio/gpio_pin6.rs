#[doc = "Reader of register GPIO_PIN6"]
pub type R = crate::R<u32, super::GPIO_PIN6>;
#[doc = "Writer for register GPIO_PIN6"]
pub type W = crate::W<u32, super::GPIO_PIN6>;
#[doc = "Register GPIO_PIN6 `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_PIN6 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `GPIO_PIN6_SYNC1_BYPASS`"]
pub type GPIO_PIN6_SYNC1_BYPASS_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GPIO_PIN6_SYNC1_BYPASS`"]
pub struct GPIO_PIN6_SYNC1_BYPASS_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_PIN6_SYNC1_BYPASS_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
#[doc = "Reader of field `GPIO_PIN6_SYNC2_BYPASS`"]
pub type GPIO_PIN6_SYNC2_BYPASS_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GPIO_PIN6_SYNC2_BYPASS`"]
pub struct GPIO_PIN6_SYNC2_BYPASS_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_PIN6_SYNC2_BYPASS_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[doc = "Bits 3:4"]
    #[inline(always)]
    pub fn gpio_pin6_sync1_bypass(&self) -> GPIO_PIN6_SYNC1_BYPASS_R {
        GPIO_PIN6_SYNC1_BYPASS_R::new(((self.bits >> 3) & 0x03) as u8)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    ...
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn gpio_pin6_sync2_bypass(&self) -> GPIO_PIN6_SYNC2_BYPASS_R {
        GPIO_PIN6_SYNC2_BYPASS_R::new((self.bits & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 13:17"]
    ...
    #[doc = "Bits 3:4"]
    #[inline(always)]
    pub fn gpio_pin6_sync1_bypass(&mut self) -> GPIO_PIN6_SYNC1_BYPASS_W {
        GPIO_PIN6_SYNC1_BYPASS_W { w: self }
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    ...
    #[doc = "Bits 0:1"]
    #[inline(always)]
    pub fn gpio_pin6_sync2_bypass(&mut self) -> GPIO_PIN6_SYNC2_BYPASS_W {
        GPIO_PIN6_SYNC2_BYPASS_W { w: self }
    }
}
