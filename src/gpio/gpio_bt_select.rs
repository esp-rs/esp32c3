#[doc = "Reader of register GPIO_BT_SELECT"]
pub type R = crate::R<u32, super::GPIO_BT_SELECT>;
#[doc = "Writer for register GPIO_BT_SELECT"]
pub type W = crate::W<u32, super::GPIO_BT_SELECT>;
#[doc = "Register GPIO_BT_SELECT `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_BT_SELECT {
    type Type = u32;
    #[inline(always)]
