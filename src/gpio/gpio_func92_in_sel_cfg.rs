#[doc = "Reader of register GPIO_FUNC92_IN_SEL_CFG"]
pub type R = crate::R<u32, super::GPIO_FUNC92_IN_SEL_CFG>;
#[doc = "Writer for register GPIO_FUNC92_IN_SEL_CFG"]
pub type W = crate::W<u32, super::GPIO_FUNC92_IN_SEL_CFG>;
#[doc = "Register GPIO_FUNC92_IN_SEL_CFG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_FUNC92_IN_SEL_CFG {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn gpio_sig92_in_sel(&self) -> GPIO_SIG92_IN_SEL_R {
        GPIO_SIG92_IN_SEL_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn gpio_func92_in_inv_sel(&self) -> GPIO_FUNC92_IN_INV_SEL_R {
        GPIO_FUNC92_IN_INV_SEL_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn gpio_func92_in_sel(&self) -> GPIO_FUNC92_IN_SEL_R {
        GPIO_FUNC92_IN_SEL_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bit 6"]
