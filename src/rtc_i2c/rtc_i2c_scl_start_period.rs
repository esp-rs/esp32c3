#[doc = "Reader of register RTC_I2C_SCL_START_PERIOD"]
pub type R = crate::R<u32, super::RTC_I2C_SCL_START_PERIOD>;
#[doc = "Writer for register RTC_I2C_SCL_START_PERIOD"]
pub type W = crate::W<u32, super::RTC_I2C_SCL_START_PERIOD>;
#[doc = "Register RTC_I2C_SCL_START_PERIOD `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_I2C_SCL_START_PERIOD {
    type Type = u32;
    #[inline(always)]
