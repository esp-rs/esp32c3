#[doc = "Reader of register LEDC_LSCH4_DUTY"]
pub type R = crate::R<u32, super::LEDC_LSCH4_DUTY>;
#[doc = "Writer for register LEDC_LSCH4_DUTY"]
pub type W = crate::W<u32, super::LEDC_LSCH4_DUTY>;
#[doc = "Register LEDC_LSCH4_DUTY `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSCH4_DUTY {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn ledc_duty_lsch4(&self) -> LEDC_DUTY_LSCH4_R {
        LEDC_DUTY_LSCH4_R::new((self.bits & 0x0007_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:18"]
