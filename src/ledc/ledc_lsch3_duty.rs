#[doc = "Reader of register LEDC_LSCH3_DUTY"]
pub type R = crate::R<u32, super::LEDC_LSCH3_DUTY>;
#[doc = "Writer for register LEDC_LSCH3_DUTY"]
pub type W = crate::W<u32, super::LEDC_LSCH3_DUTY>;
#[doc = "Register LEDC_LSCH3_DUTY `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSCH3_DUTY {
    type Type = u32;
    #[inline(always)]
