#[doc = "Reader of register LEDC_LSTIMER1_CONF"]
pub type R = crate::R<u32, super::LEDC_LSTIMER1_CONF>;
#[doc = "Writer for register LEDC_LSTIMER1_CONF"]
pub type W = crate::W<u32, super::LEDC_LSTIMER1_CONF>;
#[doc = "Register LEDC_LSTIMER1_CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSTIMER1_CONF {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `LEDC_CLK_DIV_LSTIMER1`"]
pub type LEDC_CLK_DIV_LSTIMER1_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `LEDC_CLK_DIV_LSTIMER1`"]
pub struct LEDC_CLK_DIV_LSTIMER1_W<'a> {
    w: &'a mut W,
}
impl<'a> LEDC_CLK_DIV_LSTIMER1_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[doc = "Reader of field `LEDC_LSTIMER1_DUTY_RES`"]
pub type LEDC_LSTIMER1_DUTY_RES_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `LEDC_LSTIMER1_DUTY_RES`"]
pub struct LEDC_LSTIMER1_DUTY_RES_W<'a> {
    w: &'a mut W,
}
impl<'a> LEDC_LSTIMER1_DUTY_RES_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    ...
    pub fn ledc_tick_sel_lstimer1(&self) -> LEDC_TICK_SEL_LSTIMER1_R {
        LEDC_TICK_SEL_LSTIMER1_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    pub fn ledc_lstimer1_rst(&self) -> LEDC_LSTIMER1_RST_R {
        LEDC_LSTIMER1_RST_R::new(((self.bits >> 23) & 0x01) != 0)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    pub fn ledc_lstimer1_pause(&self) -> LEDC_LSTIMER1_PAUSE_R {
        LEDC_LSTIMER1_PAUSE_R::new(((self.bits >> 22) & 0x01) != 0)
    }
    #[doc = "Bits 4:21"]
    #[inline(always)]
    pub fn ledc_clk_div_lstimer1(&self) -> LEDC_CLK_DIV_LSTIMER1_R {
        LEDC_CLK_DIV_LSTIMER1_R::new(((self.bits >> 4) & 0x0003_ffff) as u32)
    }
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn ledc_lstimer1_duty_res(&self) -> LEDC_LSTIMER1_DUTY_RES_R {
        LEDC_LSTIMER1_DUTY_RES_R::new((self.bits & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 25"]
    ...
    #[doc = "Bits 4:21"]
    #[inline(always)]
    pub fn ledc_clk_div_lstimer1(&mut self) -> LEDC_CLK_DIV_LSTIMER1_W {
        LEDC_CLK_DIV_LSTIMER1_W { w: self }
    }
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn ledc_lstimer1_duty_res(&mut self) -> LEDC_LSTIMER1_DUTY_RES_W {
        LEDC_LSTIMER1_DUTY_RES_W { w: self }
    }
}
