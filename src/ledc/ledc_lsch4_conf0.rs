#[doc = "Reader of register LEDC_LSCH4_CONF0"]
pub type R = crate::R<u32, super::LEDC_LSCH4_CONF0>;
#[doc = "Writer for register LEDC_LSCH4_CONF0"]
pub type W = crate::W<u32, super::LEDC_LSCH4_CONF0>;
#[doc = "Register LEDC_LSCH4_CONF0 `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSCH4_CONF0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `LEDC_OVF_CNT_RESET_LSCH4`"]
pub struct LEDC_OVF_CNT_RESET_LSCH4_W<'a> {
    w: &'a mut W,
}
impl<'a> LEDC_OVF_CNT_RESET_LSCH4_W<'a> {
...
#[doc = "Reader of field `LEDC_OVF_CNT_EN_LSCH4`"]
pub type LEDC_OVF_CNT_EN_LSCH4_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `LEDC_OVF_CNT_EN_LSCH4`"]
pub struct LEDC_OVF_CNT_EN_LSCH4_W<'a> {
    w: &'a mut W,
}
impl<'a> LEDC_OVF_CNT_EN_LSCH4_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `LEDC_OVF_NUM_LSCH4`"]
pub type LEDC_OVF_NUM_LSCH4_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `LEDC_OVF_NUM_LSCH4`"]
pub struct LEDC_OVF_NUM_LSCH4_W<'a> {
    w: &'a mut W,
}
impl<'a> LEDC_OVF_NUM_LSCH4_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn ledc_ovf_cnt_en_lsch4(&self) -> LEDC_OVF_CNT_EN_LSCH4_R {
        LEDC_OVF_CNT_EN_LSCH4_R::new(((self.bits >> 15) & 0x01) != 0)
    }
    #[doc = "Bits 5:14"]
    #[inline(always)]
    pub fn ledc_ovf_num_lsch4(&self) -> LEDC_OVF_NUM_LSCH4_R {
        LEDC_OVF_NUM_LSCH4_R::new(((self.bits >> 5) & 0x03ff) as u16)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 16"]
    #[inline(always)]
    pub fn ledc_ovf_cnt_reset_lsch4(&mut self) -> LEDC_OVF_CNT_RESET_LSCH4_W {
        LEDC_OVF_CNT_RESET_LSCH4_W { w: self }
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    pub fn ledc_ovf_cnt_en_lsch4(&mut self) -> LEDC_OVF_CNT_EN_LSCH4_W {
        LEDC_OVF_CNT_EN_LSCH4_W { w: self }
    }
    #[doc = "Bits 5:14"]
    #[inline(always)]
    pub fn ledc_ovf_num_lsch4(&mut self) -> LEDC_OVF_NUM_LSCH4_W {
        LEDC_OVF_NUM_LSCH4_W { w: self }
    }
    #[doc = "Bit 4"]
    #[inline(always)]
